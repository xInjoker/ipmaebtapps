...
export const initialEquipment: EquipmentItem[] = [
  ...
  { id: 'EQ-006', name: 'DJI Matrice 300 RTK', serialNumber: 'DJI-M300-2023-031', type: 'Drone', owningBranchId: 'kantor-pusat', currentLocation: 'On loan to Cabang Jakarta', calibrationDueDate: '2024-11-10', status: 'Normal', imageUrls: [], documentUrls: [], assignedPersonnelIds: [], personnelCertificationUrls: [] },
