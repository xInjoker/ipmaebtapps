...
export const initialTenders: Tender[] = [
    ...
    { id: 'TND-004', tenderNumber: 'TND-2023-105', title: 'Drill Pipe Inspection Services', client: 'ExxonMobil Cepu Limited', principal: 'ExxonMobil', description: 'Inspection services for drill pipes.', services: 'Certification Services', status: 'Awarded', submissionDate: '2023-12-20', bidPrice: 12000000000, ownerEstimatePrice: 11500000000, personInCharge: 'Eko Wahyudi', branchId: 'pekanbaru', regional: 'Regional Barat', subPortfolio: 'IAPPM', portfolio: 'AEBT', serviceCode: 'AEB-2D', serviceName: 'Verifikasi dan Pemeriksaan Mesin Pada Saat Beroprasi' },
