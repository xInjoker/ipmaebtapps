...
const reportTypes = [
  ...
  { name: 'Inspection Report (QMS)', href: '/reports/inspection', newHref: '/reports/inspection/new', icon: ClipboardCheck, description: 'Generate other QMS inspection reports.', iconColor: 'text-indigo-500', shapeColor: 'text-indigo-500/10' },
];
