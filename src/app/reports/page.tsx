...
const reportTypes = [
  ...
  { name: 'Inspection Report (QMS)', href: '/reports/inspection', newHref: '/reports/inspection/new', icon: ClipboardCheck, description: 'Generate other QMS inspection reports.', iconColor: 'text-blue-500', shapeColor: 'text-blue-500/10' },
];
