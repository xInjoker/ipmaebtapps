...
const reportTypes = [
  ...
  { name: 'Inspection Report (QMS)', href: '#', newHref: '#', icon: ClipboardCheck, description: 'Create and access detailed QMS inspection reports.', iconColor: 'text-indigo-500', shapeColor: 'text-indigo-500/10' },
];
