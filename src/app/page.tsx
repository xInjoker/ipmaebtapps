    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold font-headline">{formatCurrency(totalProjectValue)}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold font-headline">{formatCurrency(totalPaid)}</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold font-headline">{upcomingTasks.length} Tasks</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold font-headline">{formatCurrency(totalExpenditure)}</div>
            <p className="text-xs text-muted-foreground">
